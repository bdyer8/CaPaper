# -*- coding: utf-8 -*-
"""
Created on Wed Jul 15 15:02:22 2015
...
plt.imshow(np.flipud(img),extent=[0,100,0,100],alpha=.2)
plt.contourf(p,alpha=0.2)    ###plnttong the pressure field as a contour
plt.colorbar()
